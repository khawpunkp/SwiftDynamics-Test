...
function FormPage(props: any) {
    ...
    // Constant to store the editting user data
    ...
    const columns = [
        ...
        },
        {
            ...
            sorter: (a: User, b: User) => {
                ...
                const genderLabelA =
                    i18n.language === "en" ? genderA?.enName : genderA?.name;
                const genderLabelB =
                    i18n.language === "en" ? genderB?.enName : genderB?.name;
        ...
        },
        {
            ...
            render: (text: string, record: User) => {
                const nationality = nationalities.find(
                    (item) => item.alpha3 === record.nationality
                );
            ...
            defaultSortOrder: "descend" as SortOrder,
            sorter: (a: User, b: User) => {
                const nationalityA = nationalities.find(
                    (item) => item.alpha3 === a.nationality
                );
                const nationalityB = nationalities.find(
                    (item) => item.alpha3 === b.nationality
                );
                const nationalityLabelA =
                    i18n.language === "en" ? nationalityA?.enName : nationalityA?.name;
                const nationalityLabelB =
                    i18n.language === "en" ? nationalityB?.enName : nationalityB?.name;
            ...
            {props.loading ? (
                ...
                <>
                    ...
                    <div style={{ position: "relative" }}>
                        <h1 style={{ position: "absolute", left: "10px" }}>{t("form")}</h1>
                    </div>
                    <div
                        style={{
                            display: "flex",
                    ...
                    >
                            ...
                            <Col>
                                ...
                                <Row style={{ marginTop: "10px" }}>
                                    ...
                                    <Form.Item
                                        ...
                                        rules={[{ required: true, validator: validateSalary }]}
                                    >
                                        <Input
                                            id="Salary"
                                            placeholder=""
                        ...
                        <Col>
                            ...
                            >
                                ...
                                <Button onClick={() => handleDeleteUsers(selectedUserIds)}>
                                    {t("delete_data")}
                                </Button>
                            </Row>
